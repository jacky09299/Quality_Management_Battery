...
Evaluates the SOH_0 feature architecture.
"""
import numpy as np
import os
import pickle
...
def main():
    ...
    # Save a flag if better
    if t_mae < 1.76:
        print("BETTER THAN PREVIOUS BEST! We will overwrite best_model.")
        with open('better_flag.txt', 'w') as f:
            f.write(f"New MAE: {t_mae:.4f}")
